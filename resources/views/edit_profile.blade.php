                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="FullName" name="FullName" class="form-control" value="{{ old('FullName', Auth::user()->FullName ?? null) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Address" name="Address" class="form-control" value="{{ old('Address', Auth::user()->Address ?? null) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="Phone">Phone:</label>
                                    <input type="text" id="Phone" name="Phone" class="form-control" value="{{ old('Phone', Auth::user()->Phone ?? null) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="Birthday">Birthday:</label>
                                    <input type="date" id="Birthday" name="Birthday" class="form-control" value="{{ old('Birthday', Auth::user()->Birthday ?? null) }}" required>
                                </div>
                            </div>
                        </div>
